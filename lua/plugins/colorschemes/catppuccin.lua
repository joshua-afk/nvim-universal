return {
  {
    ...
    config = function()
      ...
      local default_colors = require("catppuccin.palettes").get_palette()
        ...
        highlight_overrides = {
          all = function(colors)
            return {
              ...
              NvimTreeRootFolder = { fg = colors.subtext1, style = { "bold" } },
              NvimTreeFolderIcon = { fg = colors.subtext1 },
              NvimTreeFolderName = { fg = colors.subtext0 },
              NvimTreeEmptyFolderName = { fg = colors.overlay0 },
              NvimTreeIndentMarker = { fg = colors.surface1 },
              NvimTreeModifiedFileHL = { fg = colors.peach },
              NvimTreeModifiedFolderHL = { fg = colors.peach },
              NvimTreeGitDeletedIcon = { fg = colors.red },
              NvimTreeGitDirtyIcon = { fg = colors.peach },
              NvimTreeGitIgnoredIcon = { fg = colors.overlay0 },
              NvimTreeGitMergeIcon = { fg = colors.subtext1 },
              NvimTreeGitNewIcon = { fg = colors.green },
              NvimTreeGitStagedIcon = { fg = colors.green },
              NvimTreeDiagnosticErrorFileHL = { fg = colors.red },
              NvimTreeDiagnosticWarnFileHL = { fg = colors.peach },
              NvimTreeHiddenDisplay = { fg = colors.overlay0 },
      ...
      -- Custom highlights
      api.nvim_set_hl(0, "CursorLineNr", { fg = default_colors.mauve, bold = true })
